...
const sequenceDiagrams =
  ...
  seqDiagram("SUC-1 - הרשמה לאפליקציה",
    ...
    [
      'actor "משתמש" as U',
      'participant "ניהול המשתמשים" as UM',
      'participant "מסד נתוני המשתמשים" as DB',
      "",
      "activate U",
  ...
  seqDiagram("SUC-3 - הזמנת תור",
    ...
    [
      'actor "לקוח" as C',
      'participant "ניהול התורים" as AM',
      'participant "מסד נתוני התורים" as ADB',
      'participant "מסד נתוני נותני השירות" as SDB',
      "",
      "activate C",
  ...
  seqDiagram("SUC-4 - צפייה בתורים קיימים",
    ...
    [
      'actor "לקוח" as C',
      'participant "ניהול התורים" as AM',
      'participant "מסד נתוני התורים" as DB',
      "",
      "activate C",
  ...
  seqDiagram("SUC-7 - רכישה בחנות האפליקציה",
    ...
    [
      'actor "לקוח" as C',
      'participant "ניהול החנות" as SM',
      'participant "מסד נתוני החנות" as DB',
      'participant "שירות הסליקה" as PAY',
      "",
      "activate C",
  ...
  seqDiagram("SUC-9 - ניהול יומן ושעות עבודה",
    ...
    [
      ...
      'participant "ניהול היומן" as SCM',
      'participant "מסד נתוני התורים" as ADB',
      'participant "מסד נתוני נותני השירות" as SDB',
      "",
      "activate B",
